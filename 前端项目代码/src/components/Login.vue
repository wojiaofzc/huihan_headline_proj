<template>
    <el-form ref="AccountFrom" :model="account" :rules="rules" label-position="left" label-width="0px"
        ...
        <el-form-item prop="username">
            <el-input type="text" ref="username" v-model="account.username" auto-complete="off" placeholder="账号"></el-input>
        </el-form-item>
        <el-form-item prop="pwd">
            <el-input type="text" ref="userpwd" v-model="account.pwd" auto-complete="off" placeholder="密码"></el-input>
        </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            handleLogin() {
                let that = this;
                this.account.username =  this.$refs.username.value;
                this.account.pwd = this.$refs.userpwd.value;
